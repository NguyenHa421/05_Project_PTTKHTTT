...
namespace _05_Project_PTTKHTTT.DAO_PTTKHTTT
{
    public class RecruitmentDAO
    {
        ...
        {
            string query = string.Format("insert into BaiDang values ('{0}', '{1}', N'{2}', '{3}', N'Chưa đăng', '{4}')", newRec.regID, newRec.formID, newRec.content, newRec.postdate.ToString(), newRec.staffID);
